...
<div class="nhanvien-container">
    <form method="POST" action="<?= html_helper::url(["ctl" => "nhanvien", "act" => "add"]) ?>">
        <div class="form-group">
            <label for="input-ma-nhanvien">Mã nhân viên</label>
            <input type="text" class="form-control" id="input-ma-nhanvien"  placeholder="Nhập mã nhân viên" name="ma_nv">
            <small id="ma-nhanvien-help" class="form-text text-muted"></small>
        </div>

        <div class="form-group">
            <label for="input-ten-nhanvien">Tên nhân viên</label>
            <input type="text" class="form-control" id="input-ten-nhanvien"  placeholder="Nhập tên nhân viên" name="ten_nv">
            <small id="ten-nhanvien-help" class="form-text text-muted"></small>
        </div>

        <div class="form-group">
            <label for="input-diachi-nhanvien">Địa chỉ</label>
            <input type="text" class="form-control" id="input-diachi-nhanvien"  placeholder="Nhập địa chỉ nhân viên" name="diachi_nv">
