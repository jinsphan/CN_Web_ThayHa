      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo html_helper::url(array('ctl'=>'phongban')); ?>">QUẢN LÍ PHÒNG BAN</a></li>
            <li><a href="<?php echo html_helper::url(array('ctl'=>'nhanvien')); ?>">QUẢN LÍ NHÂN VIÊN</a></li>
            <li class="dropdown">
